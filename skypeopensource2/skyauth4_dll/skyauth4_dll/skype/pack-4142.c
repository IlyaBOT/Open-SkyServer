...
u32 get_41_packed_length_7155B0(u32 * thing)
{
  ...
  switch ( thing[0] )
  {
    ...
    case 3:
      ...
      break;
    case 4:
      chars = thing[3] + packed_dword_chars_714880(thing[3]) + nchars;
      break;
    case 5:
...
u32 get_4142_packed_length_7148D0(u32 * list, char pack42)
{
  ...
  /* list is a u32 pointer: byte offsets 12 and 4 are indexes 3 and 1. */
  v5 = list[3];
  v4 = list[3];
  for (v6 = 1; v4 > 127; v6++) v4 >>= 7;
  for (v7 = 0, total_length = v6 + 1; v7 < v5; v7++)
  {
    total_length += get_41_packed_length_7155B0(v7 * 4 + (u32 *)list[1]);
  }
  return total_length;
}
