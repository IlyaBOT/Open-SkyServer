...
namespace SkyServer
{
    internal static class Program
    {
        private static int Main(string[] args)
        {
            ...
            if (!String.IsNullOrEmpty(options.KeysDirectory) && Directory.Exists(options.KeysDirectory))
            {
            ...
            {
                if (keys == null) throw new ArgumentException("No key set found. Generate keys/ or pass --keys-dir.");
    ...
    internal sealed class ServerOptions
    {
        ...
        public static ServerOptions Parse(string[] args)
        {
            ...
            {
                string nextToExe = Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "keys");
                string projectKeys = Path.GetFullPath(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "..", "..", "keys"));
                options.KeysDirectory = Directory.Exists(nextToExe) ? nextToExe : projectKeys;
            }
